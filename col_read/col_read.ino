  ...
  for (int i=0; i<7; i++)
  {
    if (cols[i]==6) h[i]=0; else{
      ...
      if ((col>=3) && (row<=2)
          ...
          && (board[row+2][col-2] == me)
          && (board[row+3][col-3] == me))
        h[i]=h[i]+16;
      ...
      //left
      if ((col>=3) 
          && (board[row][col-1] == oppo)
          && (board[row][col-2] == oppo)
          && (board[row][col-3] == oppo))
        h[i]=h[i]+8;
      //right
      if ((col<=3) 
          && (board[row][col+1] == oppo)
      ...
      //check y direction
      if ((row<=2) 
          && (board[row+1][col] == oppo)
          && (board[row+2][col] == oppo)
          && (board[row+3][col] == oppo))
        h[i]=h[i]+8;
      //check left diagonal
      if ((col>=3) && (row<=2)
          && (board[row+1][col-1] == oppo)
          && (board[row+2][col-2] == oppo)
          && (board[row+3][col-3] == oppo))
        h[i]=h[i]+8;
